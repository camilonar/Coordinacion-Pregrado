...
CREATE TABLE IF NOT EXISTS `coordpis-bd`.`usuario_programa` (
  ...
  INDEX `fk_usuario_programa_usuario1_idx` (`usuario_USUID` ASC),
  INDEX `fk_usuario_programa_programa1_idx` (`programa_idPrograma` ASC),
  PRIMARY KEY (`usuario_USUID`, `programa_idPrograma`),
  CONSTRAINT `fk_usuario_programa_usuario1`
...
INSERT INTO `usuario_departamento` (`idUsuario`, `idDepartamento`) VALUES ('2', '8');
INSERT INTO `usuario_programa` (`idUsuario`, `idPrograma`) VALUES ('1', '26');