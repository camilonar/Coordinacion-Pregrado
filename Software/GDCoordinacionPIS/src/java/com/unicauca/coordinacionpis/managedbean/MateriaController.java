...
public class MateriaController implements Serializable {
    ...
    public void confirmarEliminacion(Materia materia){
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Advertencia", "¿Está seguro que desea eliminar la materia "+materia.getNombreMateria()+" ?"));
