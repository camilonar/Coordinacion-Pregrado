 ...
 * @author Camilo
 */
public class AbstractChecklistTest {
    /**
     * Nota importante: para las pruebas el formulario de registro de checklist
    ...
    protected void goToChecklist(){
        loginAsCoordinador();
        assertLinkPresent("menu-coordinador:menuitem-checklist");
        clickLink("menu-coordinador:menuitem-checklist");
    }
    ...
    protected void goToRegistrar(){
        ...
        try {
            ...
            Logger.getLogger(AbstractChecklistTest.class.getName()).log(Level.SEVERE, null, ex);
        }
