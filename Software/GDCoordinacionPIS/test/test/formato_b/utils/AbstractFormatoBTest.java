 ...
 * @author Camilo
 */
public class AbstractFormatoBTest {
    /**
     * Nota importante: para las pruebas el formulario de registro de formato B
    ...
    protected void goToFormatoB(){
        loginAsCoordinador();
        assertLinkPresent("menu-coordinador:menuitem-formatoB");
        clickLink("menu-coordinador:menuitem-formatoB");
    }
    ...
    protected void goToRegistrar(){
        ...
        try {
            ...
            Logger.getLogger(AbstractFormatoBTest.class.getName()).log(Level.SEVERE, null, ex);
        }
